...
class Update {
    ...
    private $plugins = [
        ...
        'bdthemes-element-pack' => [
            'name' => 'ElementPaclk',
            'json_url' => '/plugins/bdthemes-element-pack.json',
            'activation' => 'bdthemes-element-pack/bdthemes-element-pack.php',
            'pro' => 1,
        ],
        'bdthemes-faq' => [
            'name' => 'BdThemes FAQ',
            'json_url' => '/plugins/bdthemes-faq.json',
            'activation' => 'bdthemes-faq/bdthemes-faq.php',
            'pro' => 1,
        ],
        'bdthemes-portfolio' => [
            'name' => 'BdThemes Portfolio',
            'json_url' => '/plugins/bdthemes-portfolio.json',
            'activation' => 'bdthemes-portfolio/bdthemes-portfolio.php',
            'pro' => 1,
        ],
        'bdthemes-testimonials' => [
            'name' => 'BdThemes Testimonials',
            'json_url' => '/plugins/bdthemes-testimonials.json',
            'activation' => 'bdthemes-testimonials/bdthemes-testimonials.php',
            'pro' => 1,
        ],
    ];
