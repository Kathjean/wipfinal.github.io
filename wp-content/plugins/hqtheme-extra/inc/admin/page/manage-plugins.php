...
class Manage_Plugins {
    ...
    private $plugins = [
        ...
        'bdthemes-element-pack' => [
            ...
            'badge' => 'pro',
            'tag' => ['all', 'pro', 'customization'],
            'description' => 'Incredibly advanced, and super-flexible widgets, and A to Z essential addons to the Elementor Page Builder for WordPress.',
            'link' => 'https://elementpack.pro/',
            'plugin_file' => 'bdthemes-element-pack/bdthemes-element-pack.php',
            'plugin_name' => 'bdthemes-element-pack',
            'constant' => '\BDTEP_VER',
        ],
        'layerslider' => [
            'name' => 'LayerSlider',
